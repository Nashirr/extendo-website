...
const Footer = () => {
  return (
    <AuroraBackground className="py-4 h-auto"> {/* Adjusted height */}
      <footer className="relative text-white py-4"> {/* Adjusted padding */}
        <div className="max-w-7xl mx-auto px-6 lg:px-20 flex flex-col lg:flex-row justify-between items-center gap-10"> {/* Adjusted gap */}
